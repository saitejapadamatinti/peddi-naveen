  ...
  data: [
    {
      ...
      description:
        "I designed UI screens for StyloDesk CRM, collaborating with the development team to ensure alignment with user experience goals and creating high-fidelity mockups and prototypes in Figma.",
      languages: [
        {
          name: "React.js",
